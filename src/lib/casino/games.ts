...
export const GAMES: GameMeta[] = [
  ...
  { slug: "flappy", name: "Flappy", blurb: "Flap past pipes, cash out before you crash.", tag: "Up to 100×", accent: "from-lime-500/20 to-emerald-500/5", c1: "#84cc16", c2: "#16a34a", glow: "rgba(132,204,22,0.55)" },
];
