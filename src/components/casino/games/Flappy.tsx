...
// pipes and only a real run turns a profit. Capped at 100x (reached ~pipe 47).
export const flappyMult = (pipes: number) => Math.min(Math.round(0.5 * Math.pow(1.12, Math.max(0, pipes)) * 100) / 100, 100);
